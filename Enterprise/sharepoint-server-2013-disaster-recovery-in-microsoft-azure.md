...
# SharePoint Server 2013 - Notfallwiederherstellung in Microsoft Azure
...
![Zeigt die Topologie und die zentralen Elemente einer SharePoint-Produktionsfarm und einer Standby-Wiederherstellungsfarm.](images/AZarch_TopWarmStndby.gif)
...
![Elemente einer betriebsbereiten SharePoint-Standbylösung in Windows Azure](images/AZarch_AZColdStndby.png)
...
Befolgen Sie die Anleitungen unter [Microsoft Azure-Architekturen für SharePoint 2013](microsoft-azure-architectures-for-sharepoint-2013.md) für den Entwurf der Umgebung für die Notfallwiederherstellung, einschließlich der SharePoint-Wiederherstellungsfarm. Sie können die Grafiken in der Visio-Datei[SharePoint-Notfallwiederherstellungslösung in Azure](https://go.microsoft.com/fwlink/p/?LinkId=392554) nutzen, um den Entwurfsprozess einzuleiten. Es wird empfohlen, dass Sie die gesamte Umgebung vor Beginn der Arbeit in der Azure-Umgebung entwerfen.
...
|:-----|:-----|:-----|:-----|
|C  <br/> |80  <br/> |Systemlaufwerk  <br/> |<Laufwerksbuchstabe>:\\Program Files\\Microsoft SQL Server\\  <br/> |
|E  <br/> |80  <br/> |Protokolllaufwerk (40 GB)  <br/> |<Laufwerksbuchstabe>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|F  <br/> |80  <br/> |Seite (36 GB)  <br/> |<Laufwerksbuchstabe>:\\Program Files\\Microsoft SQL Server\\MSSQL\\DATA  <br/> |
...
|**Laufwerksbuchstabe**|**Größe**|**Name des Verzeichnisses**|**Pfad**|
|:-----|:-----|:-----|:-----|
|C  <br/> |80  <br/> |Datenstammverzeichnis  <br/> |<Laufwerksbuchstabe>:\\Program Files\\Microsoft SQL Server\\  <br/> |
|E  <br/> |500  <br/> |Benutzerdatenbankverzeichnis  <br/> |<Laufwerksbuchstabe>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|F  <br/> |500  <br/> |Protokollverzeichnis der Benutzerdatenbank  <br/> |<Laufwerksbuchstabe>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|G  <br/> |500  <br/> |Temporäres Datenbankverzeichnis  <br/> |<Laufwerksbuchstabe>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|H  <br/> |500  <br/> |Temporäres Datenbankprotokollverzeichnis  <br/> |<Laufwerksbuchstabe>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
...
Wir haben den Parameter  _skipRegisterAsDistributedCachehost_ bei der Ausführung von **psconfig.exe** an der Befehlszeile angegeben. Weitere Informationen finden Sie unter[Planen von Feeds und des Diensts für den verteilten Cache in SharePoint Server 2013](https://go.microsoft.com/fwlink/p/?linkid=270985).
...
### Erstellen der Verfügbarkeitsgruppe missling beim Starten der "AlwaysOn_health"-XEvent-Sitzung auf <Servername>
...
[Unterstützte Hochverfügbarkeits- und Notfallwiederherstellungsoptionen für SharePoint-Datenbanken (SharePoint 2013)](https://go.microsoft.com/fwlink/p/?LinkId=393121)
