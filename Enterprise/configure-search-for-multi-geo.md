...
<p>Abbildung 1: Suchen über einen Mandanten mit drei Geo Speicherorten</p></th>
<th align="left"><p>Such-Client Ruft den Search-REST-Endpunkt mit der Abfrageeigenschaft EnableMultiGeoSearch = True.</p>
<p>Die Abfrage wird an alle Geo Speicherorte im Mandanten gesendet.</p>
<p>Suchergebnisse aus jedem Standort Geo zusammengeführt und Rangfolge.</p>
<p>Client ruft unified Suchergebnisse ab.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
### Ein Suchcenter anzuzeigenden Ergebnisse aus allen geografisch Speicherorten abrufen
...
3.  Wählen Sie die vertikal einrichten, klicken Sie auf die obere rechte Ecke Zahnradsymbol **Einstellungen** , und klicken Sie dann auf **Seite bearbeiten**.

> ![](media/configure-search-for-multi-geo_image2.png)
>
> Seite mit den Suchergebnissen wird im Bearbeitungsmodus geöffnet.

1.  In den Suchergebnisse-Webpart bewegen Sie den Zeiger auf der oberen rechten Ecke des Webparts, klicken Sie auf den Pfeil, und klicken Sie dann im Menü auf **Webpart bearbeiten** . ![](media/configure-search-for-multi-geo_image3.png)

> Der Suchergebnisse-Webpart-Toolbereich wird geöffnet, unter dem Menüband in der oberen rechten Seitenrand.
...
**MultiGeoSearchConfiguration** - Dies ist eine optionale Liste von welche Geo Speicherorten in der Multi-Geo Mandanten um die Erweiterung der Abfrage an, wenn **EnableMultiGeoSearch** **true**ist. Wenn Sie nicht fügen Sie diesen Parameter oder leer lassen, wird die Abfrage an allen Speicherorten von Geo aufgefächerte. Geben Sie für jeden Standort Geo die folgenden Elemente im JSON-Format ein:
...
**MultiGeoSearchStatus** – Dies ist eine Eigenschaft, die als Antwort auf eine Anforderung der SharePoint Search-API zurückgibt. Der Wert der Eigenschaft ist eine Zeichenfolge und gibt die folgende Informationen über die Ergebnisse, die die SharePoint-Suche-API zurückgibt:
...
<td align="left">Die Abfrage konnte keiner Abfrage mit mehreren geografisch und wurde nicht in anderen Geo Speicherorte aufgefächerte.</td>
</tr>
</tbody>
</table>
