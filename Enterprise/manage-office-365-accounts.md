...
- [Cloud Authentication](about-office-365-identity.md#cloud-authentication) – erstellen und Verwalten von Benutzern im Admin Center können Sie auch Windows PowerShell oder Azure Active Directory verwenden, um Ihre Benutzer zu verwalten. 
