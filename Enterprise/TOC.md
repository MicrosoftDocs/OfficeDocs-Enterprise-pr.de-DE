...
### [Weiterentwicklung Ihres Netzwerks für Cloudkonnektivität](evolving-your-network-for-cloud-connectivity.md)
### [Allgemeine Elemente der Microsoft-Cloudkonnektivität](common-elements-of-microsoft-cloud-connectivity.md)
...
# [Planen für Office 365](get-your-organization-ready-for-office-365.md)
## [Abonnements, Lizenzen und Mandanten](subscriptions-licenses-accounts-and-tenants-for-microsoft-cloud-offerings.md)
...
### [Entscheidung zwischen MDM und Intune](https://docs.microsoft.com/en-us/office365/securitycompliance/choose-between-mdm-and-intune)
...
### [Funktionsweise der modernen Authentifizierung in Office 2013- und Office 2016-Client-Apps](modern-auth-for-office-2013-and-2016.md)
### [Zusammenarbeit zwischen Office 365-Mandanten](office-365-inter-tenant-collaboration.md)
...
### [Identitätsverbund](federated-identity-for-your-office-365-dev-test-environment.md)
...
### [Bewährte Methoden für die Sicherheit von Office 365](https://docs.microsoft.com/office365/securitycompliance/security-best-practices)
...
#### [Endpunkte – Office 365 Deutschland](office-365-germany-endpoints.md)
...
### [NAT-Unterstützung mit Office 365](nat-support-with-office-365.md)
...
### [Vorbereiten von Benutzern auf die Bereitstellung in Office 365 über die Verzeichnissynchronisierung](prepare-for-directory-synchronization.md)
...
### [Einrichten der Verzeichnissynchronisierung für Office 365](set-up-directory-synchronization.md)
...
### [Migrieren von Daten zu Office 365](migrate-data-to-office-365.md)
...
### [Bereitstellen und Verwalten mobiler Apps](https://support.office.com/article/d35db652-629d-4087-8dc0-1e0ed922307c)
## [Schulen Ihrer Benutzer](https://support.office.com/article/396b8d9e-e118-42d0-8a0d-87d1f2f055fb)
...
## [Dienststatus](view-service-health.md)
### [Konnektivitätsüberwachung](monitor-connectivity.md)
### [Supportoptionen](https://support.office.com/en-us/article/Contact-support-for-business-products-Admin-Help-32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)
## [Verwaltungstools](https://support.office.com/en-us/article/Management-tools-for-Office-365-8e715d2a-c20e-492b-a9cb-60f3708f9241)
### [Tools zum Verwalten von Office 365-Konten](manage-office-365-accounts.md)
### [Gleichzeitiges Hinzufügen mehrerer Benutzer zu Office 365 – Administratorhilfe](add-several-users-at-the-same-time.md)
...
### [Office 365-Leistung optimieren mit Basisplänen und Leistungsverlauf ](performance-tuning-using-baselines-and-history.md)
...
### [Optimieren von Skype for Business Online](tune-skype-for-business-online-performance.md)
### [Optimieren der Leistung von Project Online](https://docs.microsoft.com/ProjectOnline/tune-project-online-performance)
### [Behandlung von Leistungsproblemen – Plan für Office 365](performance-troubleshooting-plan.md)
...
### [Ermitteln von Fehlern der Verzeichnissynchronisierung in Office 365](identify-directory-synchronization-errors.md)
### [Beheben von Problemen mit der Verzeichnissynchronisierung für Office 365](fix-problems-with-directory-synchronization.md)
