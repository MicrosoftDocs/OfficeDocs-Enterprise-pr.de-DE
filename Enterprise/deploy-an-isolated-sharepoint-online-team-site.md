...
6. Wiederholen Sie die Schritte 3 bis 5 für die zusätzlichen Gruppen.
...
5. Klicken Sie auf der Registerkarte **Berechtigungen** des Browsers auf ** \<Websitename > Mitglieder** in der Liste.
...
9. Klicken Sie auf ** \<Websitename > Besitzer** in der Liste.
...
13. Klicken Sie auf ** \<Websitename > Besucher** in der Liste.
...
- Die ** \<Websitename > Besitzer** SharePoint-Gruppe der Administratoren Access Websitegruppe, in denen alle Mitglieder die Berechtigungsstufe **Vollzugriff haben** enthält.
    
- Die ** \<Websitename > Mitglieder** SharePoint-Gruppe enthält die Mitglieder Access Websitegruppe, in der alle verfügen die Mitglieder über die Berechtigungsstufe **Bearbeiten** .
    
- Die ** \<Websitename > Besucher** SharePoint-Gruppe enthält die Websitegruppe Leser von Berichten Zugriff, in denen alle Mitglieder die Berechtigungsstufe **Lesen haben** .
