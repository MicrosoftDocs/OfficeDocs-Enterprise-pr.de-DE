...
---
# <a name="office-365-inter-tenant-collaboration"></a>Zusammenarbeit zwischen Mandanten in Office 365
...
## <a name="power-bi-collaboration-options"></a>Power BI für die Zusammenarbeitsoptionen

|**Freigabeziel**|**Administrative Aktion**|**Gewusst wie-Informationen**|
|:-----|:-----|:-----|
|Power BI kann externe Gastbenutzer über Links zu diesen freigegebenen Inhalt nutzen. Dadurch können Benutzer in der Organisation zum Verteilen von Inhalten auf sichere Weise zwischen Organisationen.<br/> | Der Power BI-Administrator können steuern, ob Benutzer externe Benutzer zum Anzeigen von Inhalten innerhalb der Organisation einladen können. <br/> |[Verteilen von Power BI-Inhalten für Gastbenutzer mit Azure AD B2B externen](https://docs.microsoft.com/en-us/power-bi/service-admin-azure-ad-b2b) <br/> |
