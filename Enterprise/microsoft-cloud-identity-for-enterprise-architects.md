...
### <a name="option-2-extend-ad-ds-to-azure"></a>Option 2: Erweitern von AD DS auf Azure
...
## <a name="integrate-your-on-premises-ad-ds-accounts-with-microsoft-azure-ad"></a>Integrieren der lokalen AD DS-Konten in Microsoft Azure AD
...
### <a name="directory-and-password-synchronization"></a>Verzeichnis- und Kennwortsynchronisierung
...
### <a name="federation-and-single-sign-on"></a>Verbund und einmaliges Anmelden
...
## <a name="extend-ad-ds-to-azure"></a>Erweitern von AD DS auf Azure
...
### <a name="on-premises-to-azure-connection-options"></a>Optionen für die lokale Verbindung zu Azure
...
## <a name="integrate-your-applications-with-cloud-identities"></a>Integrieren von Anwendungen in Cloud-Identitäten
...
### <a name="application-integration-example"></a>Beispiel für die Anwendungsintegration
...
## <a name="deploying-directory-components-in-azure"></a>Bereitstellen von Verzeichniskomponenten in Azure
...
### <a name="ad-connect-tool"></a>AD Connect-Tool
...
### <a name="federated-authentication-infrastructure"></a>Infrastruktur der Verbundauthentifizierung
...
### <a name="standalone-ad-ds-environment-in-an-azure-virtual-network"></a>Eigenständige AD DS-Umgebung in einem virtuellen Azure-Netzwerk
