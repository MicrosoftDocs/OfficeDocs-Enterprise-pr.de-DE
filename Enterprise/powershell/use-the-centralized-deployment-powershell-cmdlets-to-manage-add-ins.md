...
[Verbindung mit Ihren Administratoranmeldeinformationen](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_Connect)
  
[Hochladen einer Manifest-Add-in](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_UploadManifest)
  
[Ein Add-in aus dem Office Store hochladen](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_UploadAddin)
  
[Hier erhalten Sie von einem Add-in](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_GetDetails)
  
[Aktivieren Sie oder deaktivieren Sie eines Add-Ins](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_TurnOnOff)
  
[Hinzufügen oder Entfernen von Benutzern aus einer-Add-in](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_AddRemove)
...
[Für jedes Cmdlet detaillierte Hilfe erhalten](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_GetHelp)
